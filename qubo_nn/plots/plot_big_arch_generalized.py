...
PLOT_TAGS = [
    {
        'gc1_r2': '96x96',
        'gc1_generalized_gen2_big_arch_2': '96x96, 80x80',
        'gc1_generalized_gen3_big_arch_2': '96x96, 80x80, 64x64',
        'gc1_generalized_gen4_big_arch_2': '96x96, 80x80, 64x64, 48x48',
    }
]
PLOT_NAMES = ['gc']
PLOT_LIMS = [(0.95, 1.01, 10000)]
