...
def plot_loss(kv):
    ...
    tags = {
        'm2sat_16x16_5_F_v2': 'With duplicate checking',
        'm2sat_16x16_5_F_v2_no_dupl_chk': 'Without duplicate checking'
    }
    ...
    plt.tight_layout()
    plt.show()
    fig.savefig('m2sat_three_case_loss.png')
    fig.savefig('m2sat_three_case_loss.pdf')
...
def plot_r2(kv):
    ...
    plt.tight_layout()
    plt.show()
    fig.savefig('m2sat_three_case_r2.png')
    fig.savefig('m2sat_three_case_r2.pdf')


def run():
    with open('m2sat_three_case.pickle', 'rb') as f:
        kv = pickle.load(f)
    plot_loss(kv)
    plot_r2(kv)
