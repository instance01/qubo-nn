...
def plot_confusion(id_):
    ...
    plt.savefig('confusion_30_gen4_%s.png' % id_)
    plt.savefig('confusion_30_gen4_%s.pdf' % id_)
...
def plot(id_):
    ...
    plt.tight_layout()
    plt.show()
    fig.savefig('tot_mc_30_gen4_%s.png' % id_)
    fig.savefig('tot_mc_30_gen4_%s.pdf' % id_)


def run():
    plot_confusion('30_gen4')
    plot_confusion('30_gen4_scramble')
    plot('30_gen4')
    plot('30_gen4_scramble')
